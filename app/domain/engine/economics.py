...
def calculate_performance(effective_daily_kwh: float, daily_solar_avg: float, storage_utilization_factor: float) -> dict:
    offset = min(effective_daily_kwh, daily_solar_avg * storage_utilization_factor)
...
def calculate_economics(effective_daily_kwh: float, tariff: float, capex: float, offset_kwh: float, annual_tariff_increase: float) -> dict:
